...
ui.btnResetAll = uicontrol('Parent', parent, 'Style','pushbutton', 'Units','normalized', ...
    'Position',[0.78 0.93 0.18 0.06], 'String','Domślne', ...
...
% R niżej, żeby nie wchodziło na obszar Q
uicontrol('Parent', pLqr, 'Style','text', 'Units','normalized', ...
...
% K trochę niżej, z marginesem od dołu
ui.txtK = uicontrol('Parent', pLqr, 'Style','text', 'Units','normalized', ...
    'Position',[0.04 0.04 0.92 0.30], ...
    'String','K = [ - ]', ...
...
uicontrol('Parent', pH, 'Style','text', 'Units','normalized', ...
    'Position',[0.04 0.62 0.36 0.20], 'String','Punkt włączenia' , ...
...
uicontrol('Parent', pH, 'Style','text', 'Units','normalized', ...
    'Position',[0.04 0.30 0.36 0.22], ...
    'String','Punkt wyłączenia = on - Δ', ...
    'HorizontalAlignment','left', ...
    'BackgroundColor', bgH);
...
ui.edtThOff = uicontrol('Parent', pH, 'Style','text', 'Units','normalized', ...
    'Position',[0.42 0.30 0.18 0.22], ...
    'String', num2str(thOn0 - d0), ...
    'HorizontalAlignment','left', ...
    'BackgroundColor', bgH);


ui.btnHystPlot = uicontrol('Parent', pH, 'Style','pushbutton', 'Units','normalized', ...
    'Position',[0.72 0.06 0.24 0.18], 'String','wykres', ...
    'FontSize', 8);
